...
//char* ssid     = "Franks iPhone";
//char* password = "papaseiphone";
char* ssid     = "Unser FB WLAN";
char* password = "3556882986044453";
const char query[] = "Hörlitz,de"; // location,country
const char apiKey[] = "6c992805051a18e075b84b74710e6f79";
